...
description: "Build GuLiN Terminal from source on macOS, Linux, and Windows. Covers all prerequisites, platform-specific dependencies, task commands, and packaging."
---
