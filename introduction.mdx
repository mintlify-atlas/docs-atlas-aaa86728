...
description: "GuLiN Terminal is an open-source, AI-native terminal for macOS, Linux, and Windows — combining multi-provider AI, persistent memory, agentic tools, and a tiled workspace in one app."
---
