...
description: "Get GuLiN Terminal running in under 10 minutes — launch the app, connect an AI provider, and execute your first AI-assisted shell command using the # + TAB shortcut."
---
